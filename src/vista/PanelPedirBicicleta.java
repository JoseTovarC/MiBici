...
public class PanelPedirBicicleta extends JPanel {
	...
	public PanelPedirBicicleta(String r) {
		this.setLayout(new BorderLayout());
		label1 = new JLabel("Pedir Bicicleta. [cantidad/capacidad maxima]", SwingConstants.CENTER);
		Font auxFont=label1.getFont(); 
		label1.setFont(new Font(auxFont.getFontName(), Font.BOLD, 18));
		label2 = new JLabel("Elija la estacion (ponga el indice)", SwingConstants.CENTER);
		panel1 = new JPanel();
		...
		boton1= new JButton("Escoger.");
		boton1.setActionCommand("Escogerestacionp");
		panel3.add(texto2);
		panel3.add(boton1);
