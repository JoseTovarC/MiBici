...
public class PanelNuevoAdmin extends JPanel {
	...
	public PanelNuevoAdmin() {
		this.setLayout(new BorderLayout());

		label1 = new JLabel("Nuevo Administrador.", SwingConstants.CENTER);
		Font auxFont = label1.getFont();
		label1.setFont(new Font(auxFont.getFontName(), Font.BOLD, 18));
		label2 = new JLabel("Registrar un nuevo Administrador, rellene el formulario como se le pide.",
		...
		panel3= new JPanel();
		boton1=new JButton("Crear Nuevo Administrador.");
		boton1.setActionCommand("crearAdmin");
		panel3.add(boton1);
