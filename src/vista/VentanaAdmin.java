...
public class VentanaAdmin extends JFrame implements InterfazVista {
	...
	public TextArea texto1; // texto 1 = guia del sistema
...
//Métodos de la interfaz InterfazVista:
	...
	public void ingresardatos() {
		...
		label1.setFont(new Font(auxFont.getFontName(), Font.BOLD, 18));
		label2 = new JLabel(
				"Ingresa los datos para ingresar al sistema como usuario, y si no estas registrado, lo puedes hacer con la función 'Registrarme en el sistema' ",
				SwingConstants.CENTER);
		panel1 = new JPanel();
		panel1.setLayout(new GridLayout(2, 1, 15, 15));
		panel1.add(label1);
